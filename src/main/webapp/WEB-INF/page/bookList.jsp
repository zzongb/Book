...
<html>
	...
	<body>
		...
		<div class="container">
			<div>
				<form action="${path }/selectList" class="bs-example bs-example-form" role="form" method="post">
					<div class="row">
						<div class="col-md-3">
						...
						<div class="col-md-4">
							<a href="${path }/insertBookpage" class="btn btn-info">添加图书</a>
						</div>
					</div>
				</form>
			</div>
					...
					<tbody>
						<c:forEach items="${bookList }" var="book">
							<tr>
								...
								<td>${book.type}</td>
								<td>
									<a href="${path }/updatePage?id=${book.id}" class="btn btn-warning">修改</a>
									<a href="${path }/deletePage?id=${book.id}" class="btn btn-warning">删除</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
