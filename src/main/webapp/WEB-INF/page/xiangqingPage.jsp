...
<html>
					...
					<fieldset>
						...
						<div class="form-group">
							<div>
								<div class="form-group has-feedback">
									...
									<div class="col-md-6">
										<textarea id="remarks" name="info"  rows="1.5" cols="65"><fmt:formatDate value="${book.publishDate }" pattern="yyyy-MM-dd"></fmt:formatDate></textarea>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<button type="button" class="btn btn-warning" onclick="returnBook()">返回</button>
							</div>
						</div>
					</fieldset>
				</form>
	...
	<script type="text/javascript">
		function returnBook(){
			window.location.href="${path}/returnBook";
		}
	</script>
</html>
